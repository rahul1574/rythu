  ...
  return (
    ...
    {/* <div id='start'style={{height:'150px',display:'flex',flexDirection:'column',justifyContent:'space-evenly',alignItems:'center',background:'#fb8500'}}>
      <div style={{display:'flex',flexDirection:'column',justifyContent:'space-around',alignItems:'center'}}>
       <h2>RYTHU BAZAR</h2>
       <h4>(local community market)</h4>
      </div>
    </div>
    <div style={{background:'#283618',height:'50px',color:'black',display:'flex',flexDirection:'row',justifyContent:'space-evenly'}}>
      <p style={{color:'black'}}><Link to='/start' style={{color:'black'}}>Home</Link></p>
      <select style={{color:'black',background:'none'}}>
        <option >Area wise</option>
        <option >Saroonagar</option>
        <option >Malakpet</option>
        <option >Saidabad</option>
        <option >Champapet</option>
        <option >Karmanghat</option>
      </select>
      <select>
    ...
    <div style={{height:'600px',background:'black',display:'flex'}}>
      <img src='marketimage.webp' alt='' style={{}}></img>
      <img src='man.jpg' alt='' style={{}}></img>
    </div>
    {/* <div style={{height:'800px',display:'flex',flexDirection:'row',background:'black'}}>
      ...
      <div style={{height:'800px',background:'#fb8500'}}>
       ...
       <h4>The idea for Rythu Bazar was born out of a desire to make local produce more accessible and to support small-scale farmers and vendors in our community. As residents of [Your Community Name], we understand the challenges faced by both buyers and sellers in the traditional market setup. By leveraging our skills in web development, we aim to bridge this gap and create a vibrant, sustainable marketplace for everyone.</h4>
